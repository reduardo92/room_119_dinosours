...
function drop(event) {
  ...
  if (draggableElementId !== droppableElementId) {
    ...
    const droppableElementTextContent = event.target.querySelector('span')
      .textContent;

    event.target.style.backgroundColor = draggableElement.style.backgroundColor;
    event.target.querySelector(
      'span'
    ).textContent = draggableElement.querySelector('span').textContent;
    ...
    draggableElement.querySelector(
      'span'
    ).textContent = droppableElementTextContent;
